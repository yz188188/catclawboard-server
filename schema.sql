...
-- 如需在已有数据库上执行：
-- ALTER TABLE users ADD COLUMN password_plain VARCHAR(255) NOT NULL DEFAULT '' AFTER password_hash;
-- ALTER TABLE users ADD COLUMN role VARCHAR(20) NOT NULL DEFAULT 'user' AFTER password_plain;
